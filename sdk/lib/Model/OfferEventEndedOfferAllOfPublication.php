...
class OfferEventEndedOfferAllOfPublication implements ModelInterface, ArrayAccess
{
     ...
     * Sets ended_at
     *
     * @param \DateTime|null $ended_at Offer publication ending date and time in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format in UTC - `yyyy-MM-ddTHH:mm:ssZ`.
     *
     * @return $this
     */
